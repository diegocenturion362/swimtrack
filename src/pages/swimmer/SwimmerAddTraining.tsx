...
export function SwimmerAddTraining() {
  ...
  const [pileta, setPileta] = useState<PoolSize>(swimmer?.piletaHabitual ?? '25m')
  ...
  const handleSave = () => {
    ...
    setTimeout(() => {
      setLoading(false)
      setDone(true)
      setTimeout(() => navigate(`/nadador/${swimmerId}`), 1200)
    }, 600)
  }
  ...
  return (
    <>
      <Header title="Cargar entrenamiento" showBack backTo={`/nadador/${swimmerId}`} />
      <PageLayout>
        ...
        {/* Chip del nadador (solo informativo) */}
        {swimmer && (
          <div className="flex items-center gap-2 mb-4 px-3 py-2 bg-blue-50 rounded-xl">
            ...
            <span className="text-xs text-blue-500 ml-auto">{swimmer.pruebaPrincipal}</span>
          </div>
        )}
        ...
        {step === 0 && (
          <button
            onClick={() => navigate(`/nadador/${swimmerId}/importar`)}
        ...
        {step === 2 && (
          <div className="flex flex-col gap-4 fade-in">
            ...
            <Field label="¿Cómo llegaste al entrenamiento?">
              <div className="grid grid-cols-2 gap-2">
        ...
        {step === 3 && (
          <div className="flex flex-col gap-4 fade-in">
            <p className="text-xs text-slate-500">
              Registrá las series principales. Se genera una clave automática para comparar tu evolución en el futuro.
            </p>
              ...
              <Card className="border-blue-200 bg-blue-50">
                ...
                <div className="flex flex-col gap-3">
                  ...
                  <Field label="Observación técnica">
                    <Textarea placeholder="Sensaciones, correcciones, puntos fuertes…"
