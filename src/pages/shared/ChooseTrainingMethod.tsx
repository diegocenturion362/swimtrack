...
export function ChooseTrainingMethod({ mode }: Props) {
  ...
  const opciones = [
    {
      ...
      titulo: 'Pegar texto',
      desc:   'Escribí o pegá el entrenamiento. La app detecta metros, tiempos y series automáticamente.',
      to:     `${base}/importar`,
    },
    {
      icon:  <LayoutGrid size={36} strokeWidth={1.5} className="text-purple-600" />,
      titulo: 'Tablero',
      desc:   'Armá el entrenamiento bloque por bloque con selector de estilo, metros e intervalos.',
      to:     `${base}/tablero`,
    },
  ]
  ...
  return (
    <>
      <Header title="Cargar entrenamiento" showBack />
      <PageLayout>
        <p className="text-sm text-slate-500 mb-6">¿Cómo querés registrar el entrenamiento?</p>
